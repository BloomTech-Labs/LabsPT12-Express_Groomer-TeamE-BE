...
- `PORT` - API port (optional, but helpful with FE running as well)
  - The following ports are whitelisted for use with okta
    ...
    - 8000
    - 8080
- `DATABASE_URL` - postgres://hgwfqmoowcdihb:d2b3dd1285baf5ddaac45fe9246bd277af477a5a2bef60fa774bf4daf5005997@ec2-54-160-18-230.compute-1.amazonaws.com:5432/d4p6gdmo14gh8q
